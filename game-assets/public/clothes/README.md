...
Two mistakes were made and corrected while building this asset, both worth
knowing about for the next one:
...
The build script is `/tmp/.../scratchpad/pant_work/build_pant3.py` from the
