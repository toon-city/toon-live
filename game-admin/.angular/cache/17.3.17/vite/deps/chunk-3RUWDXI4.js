  ...
  init() {
    return __async(this, arguments, function* (options = {}) {
      ...
      for (let i = 0; i < this.runners.init.items.length; i++) {
        yield this.runners.init.items[i].init(options);
      }
...
var _TextureGCSystem = class _TextureGCSystem2 {
  ...
  init(options) {
    options = __spreadValues(__spreadValues({}, _TextureGCSystem2.defaultOptions), options);
...
var uboSyncFunctionsWGSL = __spreadProps(__spreadValues({}, uboSyncFunctionsSTD40), {
  "mat2x2<f32>": `
        data[offset] = v[0];
        data[offset + 1] = v[1];
        data[offset + 2] = v[2];
...
//# sourceMappingURL=chunk-3RUWDXI4.js.map
