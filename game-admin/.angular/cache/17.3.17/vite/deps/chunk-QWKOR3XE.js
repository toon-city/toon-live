      ...
      srcsToUse.forEach((srcs) => {
        srcs.forEach((src2) => {
          ...
          if (typeof src2 !== "object") {
            ...
            formattedAsset = __spreadValues(__spreadValues({}, formattedAsset), src2);
          }
          if (!aliasesToUse) {
    ...
    parse(asset, options, loader) {
      return __async(this, null, function* () {
        ...
        if (imageTexture instanceof Texture) {
          ...
          const assets = yield loader.load([imagePath]);
...
function detectVideoAlphaMode() {
  return __async(this, null, function* () {
    promise ?? (promise = (() => __async(this, null, function* () {
...
var buildEllipse = __spreadProps(__spreadValues({}, buildCircle), { extension: __spreadProps(__spreadValues({}, buildCircle.extension), { name: "ellipse" }) });
var buildRoundedRectangle = __spreadProps(__spreadValues({}, buildCircle), { extension: __spreadProps(__spreadValues({}, buildCircle.extension), { name: "roundedRectangle" }) });
...
var Graphics = class _Graphics extends Container {
  ...
  constructor(options) {
    ...
    const _a = options || {}, { context, roundPixels } = _a, rest = __objRest(_a, ["context", "roundPixels"]);
...
var HTMLTextSystem = class {
  ...
  _buildTexturePromise(text, resolution, style) {
    return __async(this, null, function* () {
...
//# sourceMappingURL=chunk-QWKOR3XE.js.map
